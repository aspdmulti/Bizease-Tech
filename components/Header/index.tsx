...
import menuDataIndo from "./menuDataIndo";
                      ...
                      {menuItem.submenu ? (
                        <>
                          <button
                            ...
                            className="flex cursor-pointer items-center justify-between gap-3 hover:text-[#C64D27]"
                          >
                            {menuItem.title}
                            <span>
                              <svg
                                className="h-3 w-3 cursor-pointer fill-waterloo group-hover:fill-[#C64D27]"
                          ...
                          >
                            {menuItem.submenu.map((item, key) => (
                              <li key={key} className="hover:text-[#C64D27]">
                                <Link href={item.path || "#"}>
                                  {item.title}
                                </Link>
                              </li>
